...
class CreateXhzdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('xhzd', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('bihua')->nullable()->comment('笔画数');
            ...
            $table->text('xhjieshi')->nullable()->comment('新华字典解释');
            $table->string('hzwx')->nullable()->comment('汉字五行');
            $table->timestamps();
        });
    }
